  ...
  return (
    <div className="mx-auto flex min-h-[70vh] w-full max-w-sm flex-col justify-center">
      <div className="rounded-xl border border-line bg-card p-6">
        <h1 className="text-lg font-semibold tracking-tight">Bezikee Admin</h1>
        ...
        {unprotected ? (
          <p className="mt-4 rounded-md border border-line bg-surface px-3 py-2 text-xs text-ink-muted">
            No password is configured, so the panel is currently unprotected. That
            is fine locally; set <code>ADMIN_PASSWORD</code> before exposing it
            on a URL.
          </p>
        ) : null}
