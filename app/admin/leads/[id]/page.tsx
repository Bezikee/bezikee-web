...
import { LeadDetail } from "@admin/components/lead-detail";
import { SiteGenerator } from "@admin/components/site-generator";
  ...
  return (
    <>
      <nav className="mb-4 text-sm">
        <Link href="/admin/leads/" className="text-ink-muted hover:text-accent">
          ← Leads
        </Link>
      </nav>
