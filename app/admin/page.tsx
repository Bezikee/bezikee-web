...
import { getApiUsage, getOverview } from "@admin/lib/leads/stats";
import { hasApiKey } from "@admin/lib/places/client";

// Reads the database on every request; there is nothing to prerender at build time.
      ...
      {!keyPresent ? (
        <div className="mb-6 rounded-xl border border-line bg-card-muted px-4 py-3 text-sm">
          ...
          <span className="text-ink-secondary">
            ...
            locally) before scraping. docs/ADMIN.md explains how to create one.
          </span>
        </div>
      ) : null}
