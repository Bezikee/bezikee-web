...
const TEST_DATABASE_URL =
  process.env.TEST_DATABASE_URL ?? "postgres://localhost:5432/bezikee_admin_test";
...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "server-only": path.resolve(import.meta.dirname, "./src/admin/test/server-only-stub.ts"),
    },
  },
  test: {
